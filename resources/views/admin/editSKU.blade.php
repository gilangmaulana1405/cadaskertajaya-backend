     ...
     <div class="content-wrapper">
         <div class="row">
             <div class="col-md-8 grid-margin stretch-card">
                 <div class="card">
                     <div class="card-body">
                         <h4 class="card-title">Form Edit Surat Keterangan Usaha</h4>
                         <p class="card-description">
                             Data Diri
                         </p>
                         <form class="forms-sample" method="post" action="/admin/sku/{{ $data->id }}">
                             @method('PUT')
                             @csrf
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" class="form-control numeric-input tahunUsaha" name="tahun_usaha" value="{{ $data->tahun_usaha }}" required />
                             </div>
                             <div class="form-group">
                                 <label for="inputNamausaha">Nama Usaha</label>
                                 <input type="text" class="form-control" name="nama_usaha" id="inputNamausaha" value="{{ $data->nama_usaha }}" required />
                             </div>
                             <div class="form-group">
                                 <label for="inputJenisusaha">Jenis Usaha</label>
                                 <input type="text" class="form-control alphabet-input" name="jenis_usaha" id="inputJenisusaha" value="{{ $data->jenis_usaha }}" required />
                             </div>
                             <div class="form-group">
                                 <label for="inputLokasi">Lokasi Usaha</label>
                                 <input type="text" class="form-control" name="lokasi_usaha" id="inputLokasi" value="{{ $data->lokasi_usaha }}" required />
                             </div>

                             <button type="submit" class="btn btn-primary mr-2">Update</button>
                             <a href="/admin/sku" class="btn btn-light">Cancel</a>
                         </form>
                     </div>
                 </div>
             </div>
